...
public class EnemyManager : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject boar_Prefab, cannibal_Prefabs;
    public Transform[] cannibal_SwapanPoints, boar_SwapnPoints;
    ...
    void SpawnCannibals()
    {
        ...
        {
            if (index >= cannibal_SwapanPoints.Length)
            {
                index = 0;
            }

            Instantiate(cannibal_Prefabs, cannibal_SwapanPoints[index].position, Quaternion.identity);
    ...
    void SpawnBoars()
    {
        ...
        {
            if (index >= boar_SwapnPoints.Length)
            {
                index = 0;
            }

            Instantiate(boar_Prefab, boar_SwapnPoints[index].position, Quaternion.identity);
